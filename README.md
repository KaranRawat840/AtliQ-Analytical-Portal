...
## **Live Dashboard: [Business Insights 360](https://app.powerbi.com/view?r=eyJrIjoiOWU2N2RlYWEtMmJkNi00ODQ1LWIxOWItYzgwZjk5MWQyZmRjIiwidCI6ImM2ZTU0OWIzLTVmNDUtNDAzMi1hYWU5LWQ0MjQ0ZGM1YjJjNCJ9)**
...
- Proficient in ETL methodology (Extract, Transform, Load) for data integration and transformation.

- Skilled in generating date tables and deriving fiscal months/quarters using Power Query.

- Experienced in establishing data model relationships in Power BI’s Model View.

- Proficient in enhancing data models by incorporating supplementary data.

- Advanced DAX (Data Analysis Expressions) skills to create calculated columns, tables, and measures.

- Expertise in designing and implementing interactive visuals to represent key insights effectively.

- Utilized MySQL Database for data loading, retrieval, and integration.

- Optimized Power BI file size and performance using DAX Studio.

## **Soft Skills:**

- Strong understanding of business domains: Finance, Sales, Marketing, Supply Chain, and Executive decision-making.

- Designed user-centric dashboards with a focus on empathy and usability.
